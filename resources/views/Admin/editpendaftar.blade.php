    ...
    <div class="card-body">
        <form action="{{ route('datapendaftar.updatependaftar', $editpendaftar->pendaftar_id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="YYYY" required="required" id="tahun" name="tahun" class="form-control" value="{{ $editpendaftar->tahun }}">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <select class="form-control"  required="required" name="program_studi" aria-label="Default select example" >
                        <option value="{{$editpendaftar->program_studi}}">{{$editpendaftar->program_studi}}</option>
