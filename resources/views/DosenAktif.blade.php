...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">DATA DOSEN AKTIF INSTITUT TEKNOLOGI DEL</h1>
                ...
                <tbody>
                    ...
                    @foreach ($dosenaktif as $dos)
                        <tr>
                            ...
                            <td width="8%">{{ $dos->prodi }}</td>
                            <td width="15%">{{ $dos->jabatanAkademik }}</td>
                            <td width="5%"><center>{{ $dos->golonganKepangkatan }}</center></td>
                            <td width="12%">{{ $dos->statusIkatan }}</td>
