            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Dosen Aktif</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card card-secondary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{route('datadosenaktif.updatedosenaktif',$editdosenaktif->id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                        <div class="mb-3 row">
