...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>DATA PENAMBAHAN ASET AUDIO VISUAL</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard Admin</a></li>
                        <li class="breadcrumb-item active">Data Penambahan Aset Audio Visual</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Penambahan Aset Audio Visual</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body table-responsive">
                                            ...
                                            <td width="9%">
                                                <center>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <button class="dropdown-item" onclick="window.location.href='/datalaudiovisual/editlaudiovisual/{{ $lg->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                                    </div>
                            ...
                            <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='/tambahlaudiovisual'"><i
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Hapus Data Penambahan Aset Audio Visual</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-sm"
                        onclick="window.location.href='/datalaudiovisual/deletelaudiovisual/{{ $lg->id }}'">Hapus</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Lihat Data Penambahan Aset Audio Visual</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="row">
