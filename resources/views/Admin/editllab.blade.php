...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Edit Data Alat - Alat LAB, Peraga, Kesenian, Kesehatan dll</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('datallab.updatellab', $editllab->id) }}" method="post"
