...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>EDIT PEMUSNAHAN PERALATAN TAMAN</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/beranda">Dashboard Admin</a></li>
                        <li class="breadcrumb-item"><a href="/datadisptaman">Pemusnahan Aset Peralatan Taman</a></li>
                        <li class="breadcrumb-item active">Edit Pemusnahan Aset Peralatan Taman</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            <div class="card card-secondary">
                                <div class="card-header">
                                  <h3 class="card-title">Edit Pemusnahan Aset Peralatan Taman</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('datadisptaman.updatedisptaman', $editdisptaman->id) }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                        <div class="mb-3 row">
